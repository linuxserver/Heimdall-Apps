...
<div class="items">
    ...
    <div class="input">
        ...
        {!! Form::password('config[password]', (isset($item) ? $item->getconfig()->password : null), (isset($item) ? $item->getconfig()->password : null), array('placeholder' => __('app.apps.password'), 'data-config' => 'password', 'class' => 'form-control config-item')) !!}
    </div>
    <div class="input">
