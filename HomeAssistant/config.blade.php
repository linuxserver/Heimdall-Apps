...
<div class="items" style="flex-direction:column">
    ...
    <div style="display:flex;flex-direction:row;">
        ...
        <div class="input">
            ...
            {!! Form::text('config[second_stat_template]', (isset($item) ? $item->getconfig()->second_stat_template : null), array('placeholder' => __('Default: @{{ states.light | selectattr(\'state\',\'equalto\',\'on\') | list | count }}'), 'data-config' => 'second_stat_template', 'class' => 'form-control config-item')) !!}
        </div>
    </div>
    <div class="input">
