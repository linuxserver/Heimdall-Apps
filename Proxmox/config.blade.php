...
<div class="items" style="flex-wrap: wrap;">
    ...
    <div class="input">
        ...
        {!! Form::text('config[nodes]', (isset($item) ? $item->getconfig()->nodes : null), array('placeholder' => 'Leave blank for all nodes in cluster', 'data-config' => 'nodes', 'class' => 'form-control config-item')) !!}
    </div>
    <div class="input">
    ...
    <div class="input">
        ...
        {!! Form::text('config[token_id]', (isset($item) ? $item->getconfig()->token_id : null), array('placeholder' => 'user@realm!token_name', 'data-config' => 'token_id', 'class' => 'form-control config-item')) !!}
    </div>
    <div class="input">
        <label>API Token Value</label>
        {!! Form::input('password', 'config[token_value]', (isset($item) ? $item->getconfig()->token_value : null), array('placeholder' =>'01234567-89ab-cdef-0123-456789abcdef', 'data-config' => 'token_value', 'class' => 'form-control config-item')) !!}
    </div>
    <div class="input">
