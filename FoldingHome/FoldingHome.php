...
namespace App\SupportedApps\FoldingHome;
...
class FoldingHome extends \App\SupportedApps implements \App\EnhancedApps
{
    ...
    public function livestats()
    {
        ...
        $progress = isset($details[1][1][0]["percentdone"])
            ? $details[1][1][0]["percentdone"]
            : "N/A";
        $eta = isset($details[1][1][0]["eta"])
            ? $details[1][1][0]["eta"]
            : "N/A";
    ...
    public function setSID()
    {
        if (empty($this->sid)) {
            ...
            $res2 = parent::execute($this->url("api/updates/set"), [
                "query" => $query_data,
            ]);
            $query_data2 = [
                "sid" => $this->sid,
            ...
            $res3 = parent::execute($this->url("api/updates/set"), [
                "query" => $query_data2,
            ]);
            $query_data3 = [
                "sid" => $this->sid,
            ...
            $res4 = parent::execute($this->url("api/configured"), [
                "query" => $query_data3,
            ]);
        }
    }
