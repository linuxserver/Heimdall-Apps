...
namespace App\SupportedApps\Deluge;
...
class Deluge extends \App\SupportedApps implements \App\EnhancedApps
{
    ...
    public function livestats()
    {
        ...
        $attrs = [
            "body" =>
                '{"method": "web.update_ui", "params": [["none"], {}], "id": 1}',
            "cookies" => $this->jar,
            "headers" => [
                "content-type" => "application/json",
                "Accept" => "application/json",
        ...
        if ($details) {
            ...
            $status =
                self::getState($states, "Active") > 0 ? "active" : "inactive";
        }
    ...
    protected static function getState(
        ...
        $state = Arr::first($states, function (array $state) use (
            $wantedState
        ) {
