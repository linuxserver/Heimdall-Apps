...
<div class="items">
    ...
    <div class="input">
        ...
        {!! Form::text('config[section_1_key]', isset($item) ? $item->getconfig()->section_1_key : null, ['placeholder' => __('section_1_key'), 'data-config' => 'section_1_key', 'class' => 'form-control config-item']) !!}
    </div>
    <div class="input">
        ...
        {!! Form::text('config[section_2_key]', isset($item) ? $item->getconfig()->section_2_key : null, ['placeholder' => __('section_2_key'), 'data-config' => 'section_2_key', 'class' => 'form-control config-item']) !!}
    </div>
    <div class="input">
