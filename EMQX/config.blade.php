...
<div class="items">
    ...
    <div class="input">
        ...
        <small>Dashboard &raquo; System &raquo; API Key</small>
    </div>
    <div class="input">
        ...
        <small>API Key Secret</small>
    </div>
    <div class="input">
        <button style="margin-top: 32px;" class="btn test" id="test_config">Test</button>
    </div>
    {{-- Connection/subscription counts change gradually; refresh on the 30s "data only" cadence, not every 5s. --}}
