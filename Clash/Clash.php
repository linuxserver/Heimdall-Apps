<?php namespace App\SupportedApps\Clash;
...
class Clash extends \App\SupportedApps implements \App\EnhancedApps {
    ...
    public function livestats()
    {
        ...
        $sel_value = (isset($res) && isset($res->proxies) && isset($res->proxies->{$sel_name})) ? $res->proxies->{$sel_name}->now : '';
    ...
    {
        $api_url = parent::normaliseurl($this->getConfigValue('override_url', $this->config->url)).$endpoint;
        return $api_url;
    }
