...
namespace App\SupportedApps\Ghost;
...
class Ghost extends \App\SupportedApps implements \App\EnhancedApps
{
    ...
    public function auth()
    {
        ...
        $result = parent::execute(
            $this->url("ghost/api/v3/admin/session"),
            $attrs,
            $vars,
            "POST"
        );
    ...
    public function livestats()
    {
        ...
        $result = parent::execute(
            $this->url("ghost/api/v3/admin/posts/"),
            $attrs,
            []
        );
        if (null === $result) {
        ...
        $data = [
            ...
            "scheduled" => isset($statuses["scheduled"])
                ? $statuses["scheduled"]
                : 0,
            "published" => isset($statuses["published"])
                ? $statuses["published"]
                : 0,
        ];
        $status = "active";
